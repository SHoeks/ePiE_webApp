saveStatsToExcelRisks = function() {
    
    console.log("saveStatsToExcelRisks");
    ...
    var file_name = "ePiE_risks_stats_" + new Date().toISOString().slice(0,10) + "_" + new Date().toISOString().slice(11,19).replace(/:/g, "") + ".xlsx";
